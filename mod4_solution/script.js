...
const map1 = names.map(greetname);
console.log(map1.join('\r\n'));

//Bonus Task
function greetname2(result, name, currentIndex, names) {
  var firstLetter = name.charAt(0).toLowerCase();
  if (firstLetter === 'j') {
...
result = names.reduce(greetname2, {hello: [], bye: []})
console.log(result.hello.join('\r\n'));
console.log(result.bye.join('\r\n'));
