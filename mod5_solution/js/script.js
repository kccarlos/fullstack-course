...
// produces a random number from 1 to 5 (inclusively) for star ratings
function randomOnetoFiveNum (){
...
dc.loadAboutPage = function () {
  ...
  $ajaxUtils.sendGetRequest(
      aboutHtmlUrl,
      function (abouthtml) {
        var starnum = randomOnetoFiveNum();
        //set the number of bright stars in html
        for (let i = 1; i < 6; i ++) {
          if (i <= starnum) {
        ...
        abouthtml += "<div class='text-center'>";
        abouthtml += starnum.toString() + "-star rating</div>";
